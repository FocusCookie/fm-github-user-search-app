...
const themeBtnText = document.getElementById("theme-btn-toggle--text");
...
themeBtn.addEventListener("click", function () {
  ...
  const iconsCurrentPath = themeIconPath.getAttribute("d");
  ...
  if (iconsCurrentPath === moonPath) {
    setSvgPath(themeIconPath, sunPath);
    themeBtnText.innerHTML = "Light";
  } else {
    themeBtnText.innerHTML = "Dark";
    setSvgPath(themeIconPath, moonPath);
  }
});
